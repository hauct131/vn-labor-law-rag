...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Tổng số bảng: **{article_stats['table_count']}**",
        f"- Bảng thuộc điều: **{article_stats['article_table_count']}**",
        f"- Bảng thuộc phụ lục: **{article_stats['attachment_table_count']}**",
        f"- Tổng attachment: **{article_stats['attachment_count']}**",
        f"- File gắn với điều: **{article_stats['article_attachment_count']}**",
        f"- Phụ lục cấp tài liệu: **{article_stats['document_attachment_count']}**",
